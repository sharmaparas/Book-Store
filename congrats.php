...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Congrats!!</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">
             <h4>Congrats!! You have successfully registered with our website</h4>
			 <h4><a href="myaccount.php">Go to My Account</a> </h4>
</p>
<p>
