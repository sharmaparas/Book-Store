<?PHP 
			 session_start();
$msg="";
				if(isset($_SESSION["certCode"]))
				{
$msg = "You have received the discount of 2$ for your Certificate Code - ".$_SESSION["certCode"];
				}
				else
				{
					echo"no";
...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Order Completed Successfully!!</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">
             <h4>Congrats!! You have successfully made the order.</h4>
<?PHP
echo $msg;
?>
			 <br>
			 
			 <h4><a href="myorders.php">Go to My Orders</a> </h4>
</p>
<p>
